    ...
    <main className="site-shell">
      ...
      <section id="home" className="hero section-frame">
        ...
        <aside className="hero-rail">
          ...
          <div className="social-row"><a href="https://github.com/MUNYOH-JOEL-TAMON" target="_blank" rel="noopener noreferrer" aria-label="GitHub"><Github size={17} /></a><a href="https://www.linkedin.com/in/munyoh-joel-tamon" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"><Linkedin size={17} /></a><a href="mailto:joelmunyoy123@gmail.com?subject=Hey Joel — Let's Connect" target="_blank" rel="noopener noreferrer" aria-label="Email"><Mail size={17} /></a></div>
        </aside>
      </section>
      ...
      <section id="contact" className="contact section-frame"><div className="contact-orb" /><SectionLabel number="06">A GOOD PLACE TO START</SectionLabel><h2>Have a hard problem?<br /><span>Let’s map the first move.</span></h2><p>Tell me what you’re working on, what feels unclear, or where the system is stuck. I’ll get back to you with a useful next step.</p><a className="contact-button" href="mailto:joelmunyoy123@gmail.com?subject=Hey Joel — Let's Connect" target="_blank" rel="noopener noreferrer">joelmunyoy123@gmail.com <Send size={16} /></a><div className="contact-bottom"><span>MUNYOH JOEL TAMON / 2026</span><span>BUILT WITH CARE <i className="green-dot" /></span></div></section>
    </main>
  );
}
