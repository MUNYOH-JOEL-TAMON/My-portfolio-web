    ...
    <main className="site-shell">
      ...
      <section id="home" className="hero section-frame">
        ...
        <aside className="hero-rail">
          ...
          <div className="social-row"><a href="https://github.com/MUNYOH-JOEL-TAMON" target="_blank" rel="noopener noreferrer" aria-label="GitHub"><Github size={17} /></a><a href="https://www.linkedin.com/in/munyoh-joel-tamon" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"><Linkedin size={17} /></a><a href="https://mail.google.com/mail/?view=cm&fs=1&to=joelmunyoy123@gmail.com&su=Hey Joel — Let's Connect" target="_blank" rel="noopener noreferrer" aria-label="Email"><Mail size={17} /></a></div>
        </aside>
      </section>
