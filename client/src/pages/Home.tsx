...
const skills = [
  ...
  { name: "AWS", category: "Cloud", signal: "Runtime layer", evidence: "Used to move ideas live", icon: Cloud },
];
    ...
    <main className="site-shell">
      ...
      <section id="home" className="hero section-frame">
        ...
        <aside className="hero-rail">
          ...
          <div className="social-row"><a href="https://github.com/MUNYOH-JOEL-TAMON" target="_blank" rel="noopener noreferrer" aria-label="GitHub"><Github size={17} /></a><a href="https://www.linkedin.com/in/munyoh-joel-tamon" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"><Linkedin size={17} /></a><a href="mailto:joelmunyoy123@gmail.com?subject=Reaching Out from Your Portfolio" target="_blank" rel="noopener noreferrer" aria-label="Email"><Mail size={17} /></a></div>
        </aside>
      </section>
      ...
      <section id="skills" className="skills section-frame content-section">
        ...
        <div className="tech-marquee">
          <div className="tech-marquee-content">
            <span>REACT</span><i>•</i><span>PYTHON</span><i>•</i><span>POSTGRESQL</span><i>•</i><span>OPENAI</span><i>•</i><span>AWS</span><i>•</i><span>NODE.JS</span><i>•</i>
            <span>REACT</span><i>•</i><span>PYTHON</span><i>•</i><span>POSTGRESQL</span><i>•</i><span>OPENAI</span><i>•</i><span>AWS</span><i>•</i><span>NODE.JS</span><i>•</i>
          </div>
        </div>
      </section>
      ...
      <section id="contact" className="contact section-frame"><div className="contact-orb" /><SectionLabel number="06">A GOOD PLACE TO START</SectionLabel><h2>Have a hard problem?<br /><span>Let’s map the first move.</span></h2><p>Tell me what you’re working on, what feels unclear, or where the system is stuck. I’ll get back to you with a useful next step.</p><a className="contact-button" href="mailto:joelmunyoy123@gmail.com?subject=Reaching Out from Your Portfolio" target="_blank" rel="noopener noreferrer">joelmunyoy123@gmail.com <Send size={16} /></a><div className="contact-bottom"><span>MUNYOH JOEL TAMON / 2026</span><span>BUILT WITH CARE <i className="green-dot" /></span></div></section>
    </main>
  );
}
